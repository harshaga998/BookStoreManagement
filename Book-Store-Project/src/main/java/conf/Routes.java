...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {  
        ...
        router.GET().route("/signup").with(BookController::ssignup);
        router.POST().route("/signup").with(BookController::signupNew);
      ...
      // router.POST().route("/article/new").with(ArticleController::articleNewPost);
       router.POST().route("/article/new").with(BookController::bookNewPost);
       router.GET().route("/allbooks").with(BookController::getbooksJson);
        ...
        // Create new article
        ///////////////////////////////////////////////////////////////////////
        router.GET().route("/article/{id}").with(BookController::bookShow);
        router.GET().route("/delete/{id}").with(BookController::deleted);
        router.POST().route("/update/{id}").with(BookController::updatedbook);
        router.GET().route("/update/{id}").with(BookController::update);
        ///////////////////////////////////////////////////////////////////////
